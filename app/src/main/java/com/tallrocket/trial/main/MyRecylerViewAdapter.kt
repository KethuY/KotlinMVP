...
class MyRecylerViewAdapter(var context: Context?, var employees: ArrayList<Employee>, var listener: ItemClick?) : RecyclerView.Adapter<MyRecylerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.mRelativeLayout.setOnClickListener {
            listener?.onItemClick(position, employees[position]);
        }
